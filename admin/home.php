...
<div class="main-content">
    ...
    <section class="statistics row">
            ...
            <a href="index.php?page=products">
                <div class="card mb-3 widget-chart">
                    ...
                    <span class="widget-numbers">
                        <?php 
                            $qtproducts = get_quantities_product();
                            echo $qtproducts['quantityproducts'];
                        ?>
                    </span>
                </div>
            </a>
        ...
        <div class="col-sm-12 col-md-6 col-xl-4">
            <a href="index.php?page=users">
                <div class="card mb-3 widget-chart">
                    ...
                    <span class="widget-numbers">
                        <?php 
                            $qtusers = get_quantities_user();
                            echo $qtusers['quantityusers'];
                        ?>
                    </span>
                </div>
            </a>
        ...
        <div class="col-sm-12 col-md-6 col-xl-4">
            <a href="index.php?page=caterogies">
                <div class="card mb-3 widget-chart">
                    <div class="widget-subheading fsize-1 pt-2 opacity-10 text-warning font-weight-bold">
                        <h5>
                            Tổng doanh mục
                    ...
                    <span class="widget-numbers">
                        <?php 
                            $qtkinds = get_quantities_kind();
                            echo $qtkinds['quantitykinds'];
                        ?>
                    </span>
                </div>
            </a>
